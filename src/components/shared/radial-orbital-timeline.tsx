...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[600px] md:h-[700px] flex flex-col items-center justify-center bg-background relative overflow-hidden rounded-2xl border"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-primary via-primary/70 to-accent animate-pulse flex items-center justify-center z-10">
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-card/95 backdrop-blur-lg border shadow-xl overflow-visible">
