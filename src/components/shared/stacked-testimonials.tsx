...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-white/10 bg-[#0a0a0a]/80 p-6 backdrop-blur-md",
      light:
...
export const TestimonialContainerScroll: React.FC<
...
TestimonialContainerScroll.displayName = "TestimonialContainerScroll";
